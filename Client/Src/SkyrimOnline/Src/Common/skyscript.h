...
namespace Game
{
    ...
    static Actor * FindClosestActor(float afX, float afY, float afZ, float afRadius) {
        return NativeInvoke::Invoke<Actor *>("Game", "FindClosestActor", BSScript_StaticFunctionTag, afX, afY, afZ, afRadius);
    }

    static Actor * FindRandomActor(float afX, float afY, float afZ, float afRadius) {
        return NativeInvoke::Invoke<Actor *>("Game", "FindRandomActor", BSScript_StaticFunctionTag, afX, afY, afZ, afRadius);
    }
    ...
    static Actor * GetPlayer() {
        return NativeInvoke::Invoke<Actor *>("Game", "GetPlayer", BSScript_StaticFunctionTag);
    }
    ...
    static Actor * GetPlayersLastRiddenHorse() {
        return NativeInvoke::Invoke<Actor *>("Game", "GetPlayersLastRiddenHorse", BSScript_StaticFunctionTag);
    }
    ...
    static void SetCameraTarget(Actor * arTarget) {
    ...
    static void ShowTrainingMenu(Actor * aTrainer) {
...
namespace Form
{
    ...
    static void RegisterForLOS(TESForm * self, Actor * akViewer, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("Form", "RegisterForLOS", self, akViewer, akTarget);
    }

    static void RegisterForSingleLOSGain(TESForm * self, Actor * akViewer, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("Form", "RegisterForSingleLOSGain", self, akViewer, akTarget);
    }

    static void RegisterForSingleLOSLost(TESForm * self, Actor * akViewer, TESObjectREFR * akTarget) {
    ...
    static void UnregisterForLOS(TESForm * self, Actor * akViewer, TESObjectREFR * akTarget) {
...
namespace ObjectReference
{
    ...
    static bool AddItem(TESObjectREFR * self, TESForm * akItemToAdd, uint32_t aiCount, bool abSilent) {
    ...
    static void CreateDetectionEvent(TESObjectREFR * self, Actor * akOwner, uint aiSoundLevel) {
    ...
    static Actor * PlaceActorAtMe(TESObjectREFR * self, TESNPC * akActorToPlace, uint aiLevelMod, BGSEncounterZone * akZone) {
        return NativeInvoke::Invoke<Actor *>("ObjectReference", "PlaceActorAtMe", self, akActorToPlace, aiLevelMod, akZone);
    }
    ...
    static void PushActorAway(TESObjectREFR * self, Actor * akActorToPush, float aiKnockbackForce) {
    ...
    static void Say(TESObjectREFR * self, TESTopic * akTopicToSay, Actor * akActorToSpeakAs, bool abSpeakInPlayersHead) {
        NativeInvoke::Invoke<ScriptNone>("ObjectReference", "Say", self, akTopicToSay, akActorToSpeakAs, abSpeakInPlayersHead);
    }

    static void SendStealAlarm(TESObjectREFR * self, Actor * akThief) {
        NativeInvoke::Invoke<ScriptNone>("ObjectReference", "SendStealAlarm", self, akThief);
    }

    static void SetActorCause(TESObjectREFR * self, Actor * akActor) {
...
namespace SActor
{
    ...
    static void DispelAllSpells(Actor * self) {
        NativeInvoke::Invoke<ScriptNone>("Actor", "DispelAllSpells", self);
    }

    static bool DispelSpell(Actor * self, SpellItem * akSpell) {
        return NativeInvoke::Invoke<bool>("Actor", "DispelSpell", self, akSpell);
    }

    static void DoCombatSpellApply(Actor * self, SpellItem * akSpell, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("Actor", "DoCombatSpellApply", self, akSpell, akTarget);
    }

    static void EnableAI(Actor * self, bool abEnable) {
    ...
    static void EquipSpell(Actor * self, SpellItem * akSpell, uint aiSource) {
        NativeInvoke::Invoke<ScriptNone>("Actor", "EquipSpell", self, akSpell, aiSource);
    }

    static void EvaluatePackage(Actor * self) {
        NativeInvoke::Invoke<ScriptNone>("Actor", "EvaluatePackage", self);
    }

    static void ForceActorValue(Actor * self, char * asValueName, float afNewValue) {
        char *_asValueName = BSString_Create(asValueName);
        NativeInvoke::Invoke<ScriptNone>("Actor", "ForceActorValue", self, &_asValueName, afNewValue);
        BSString_Free(_asValueName);
    }

    static float GetActorValue(Actor * self, char * asValueName) {
        char *_asValueName = BSString_Create(asValueName);
    ...
    static float GetActorValuePercentage(Actor * self, char * asValueName) {
        char *_asValueName = BSString_Create(asValueName);
    ...
    static float GetBaseActorValue(Actor * self, char * asValueName) {
        char *_asValueName = BSString_Create(asValueName);
...
namespace Alias
{
    ...
    static void RegisterForLOS(BGSBaseAlias * self, Actor * akViewer, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("Alias", "RegisterForLOS", self, akViewer, akTarget);
    }

    static void RegisterForSingleLOSGain(BGSBaseAlias * self, Actor * akViewer, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("Alias", "RegisterForSingleLOSGain", self, akViewer, akTarget);
    }

    static void RegisterForSingleLOSLost(BGSBaseAlias * self, Actor * akViewer, TESObjectREFR * akTarget) {
    ...
    static void UnregisterForLOS(BGSBaseAlias * self, Actor * akViewer, TESObjectREFR * akTarget) {
...
namespace Spell
{
    ...
    static bool RemoteCast(SpellItem * self, TESObjectREFR * akSource, Actor * akBlameActor, TESObjectREFR * akTarget) {
...
namespace ActiveMagicEffect
{
    ...
    static Actor * GetCasterActor(ActiveEffect * self) {
        return NativeInvoke::Invoke<Actor *>("ActiveMagicEffect", "GetCasterActor", self);
    }

    static Actor * GetTargetActor(ActiveEffect * self) {
        return NativeInvoke::Invoke<Actor *>("ActiveMagicEffect", "GetTargetActor", self);
    }
    ...
    static void RegisterForLOS(ActiveEffect * self, Actor * akViewer, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("ActiveMagicEffect", "RegisterForLOS", self, akViewer, akTarget);
    }

    static void RegisterForSingleLOSGain(ActiveEffect * self, Actor * akViewer, TESObjectREFR * akTarget) {
        NativeInvoke::Invoke<ScriptNone>("ActiveMagicEffect", "RegisterForSingleLOSGain", self, akViewer, akTarget);
    }

    static void RegisterForSingleLOSLost(ActiveEffect * self, Actor * akViewer, TESObjectREFR * akTarget) {
    ...
    static void UnregisterForLOS(ActiveEffect * self, Actor * akViewer, TESObjectREFR * akTarget) {

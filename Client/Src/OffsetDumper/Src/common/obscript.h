...
namespace Obscript
{
    ...
    static double SameFaction(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("SameFaction", self, CActor);
    }

    static double SameRace(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("SameRace", self, CActor);
    }

    static double SameSex(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("SameSex", self, CActor);
    }

    static double GetDetected(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetDetected", self, CActor);
    }
    ...
    static double GetFactionRankDifference(TESObjectREFR * self, ScriptAny Faction, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetFactionRankDifference", self, Faction, CActor);
    }

    static double GetShouldAttack(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetShouldAttack", self, CActor);
    }
    ...
    static double GetCrime(TESObjectREFR * self, ScriptAny CActor, ScriptAny CrimeTypeoptional) { 
        return ObscriptInvoke::Invoke("GetCrime", self, CActor, CrimeTypeoptional);
    }
    ...
    static double GetTalkedToPCParam(ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetTalkedToPCParam", 0, CActor);
    }
    ...
    static double HasAssociationType(TESObjectREFR * self, ScriptAny CActor, ScriptAny AssociationType) { 
        return ObscriptInvoke::Invoke("HasAssociationType", self, CActor, AssociationType);
    }

    static double HasFamilyRelationship(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("HasFamilyRelationship", self, CActor);
    }

    static double HasParentRelationship(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("HasParentRelationship", self, CActor);
    }
    ...
    static double IsTalkingActivatorActor(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("IsTalkingActivatorActor", self, CActor);
    }
    ...
    static double GetRelationshipRank(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetRelationshipRank", self, CActor);
    }
    ...
    static double IsKiller(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("IsKiller", self, CActor);
    }
    ...
    static double GetFactionRelation(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetFactionRelation", self, CActor);
    }
    ...
    static double GetThreatRatio(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetThreatRatio", self, CActor);
    }
    ...
    static double IsCombatTarget(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("IsCombatTarget", self, CActor);
    }
    ...
    static double ShouldAttackKill(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("ShouldAttackKill", self, CActor);
    }
    ...
    static double GetShouldHelp(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("GetShouldHelp", self, CActor);
    }
    ...
    static double IsHostileToActor(TESObjectREFR * self, ScriptAny CActor) { 
        return ObscriptInvoke::Invoke("IsHostileToActor", self, CActor);
    }

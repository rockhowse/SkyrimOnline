...
namespace Game.Server
{
    class Program
    {
        ...
        private static IniLoader iniLoader = new IniLoader(ServerConfig.SERVER_CONFIG_FILE);
        ...
        static GameServer CreateServer()
        {
            ...
            if (!File.Exists(ServerConfig.SERVER_CONFIG_FILE))
            {
                ...
                writer.addKeyToSelectedSection(ServerConfig.GENERAL_KEY_PASSWORD, "", "If password is set game will be private only for players with password, defaulat: \"\" ");

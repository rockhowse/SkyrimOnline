...
namespace Game.Tools.CommandLine
{
    public class Commands
    {
        ...
        public static readonly string DESCRIPTION_EXIT = "exit - save and closing server";

        public static readonly string COMMAND_RELOAD = "reload";
        public static readonly string DESCRIPTION_RELOAD = "reload <arg> - reload some arg modules";
